...
if (
  ...
  packageId !== "@firefly-harness/bundle-companion"
) {
  throw new Error(
    "Firefly product bundle must be @firefly-harness/bundle-companion",
  );
}
...
if (!clientBundle.startsWith("window.__ModuleLoader__.load(")) {
  throw new Error("Firefly companion client bundle is missing its Harness loader wrapper");
}
if (/require\(["']@deepseek-ai\//u.test(clientBundle)) {
  throw new Error(
    "Firefly companion client bundle leaked a non-platform Harness value import",
  );
}
