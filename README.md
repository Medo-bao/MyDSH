...
1. Download the Windows x64 `.exe` installer from [MyDSH releases](https://github.com/Medo-bao/MyDSH/releases). The current version is **0.0.1**.
...
Build MyDSH on a Windows x64 host. The build produces distributables under `out/make`; macOS/Linux and cross-platform packaging are currently unsupported.
